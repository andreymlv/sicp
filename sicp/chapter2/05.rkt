...
(check-eq? (cons 4 5) (* (* 2 2 2 2) (* 3 3 3 3 3)))
...
(check-eq? (remove-multiplier 3888 3) 16)
...
(check-eq? (log-with-base 2 1024) 10.0)
...
(check-eq? (cdr (cons 4 5)) 5.0)

(check-eq? (let ((z (cons 4 5))) (cons (car z) (cdr z))) 3888.0)